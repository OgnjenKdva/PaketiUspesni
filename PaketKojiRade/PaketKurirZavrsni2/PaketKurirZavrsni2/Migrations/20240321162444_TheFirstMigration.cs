        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dostavljen = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1998, "Boban" });

            migrationBuilder.InsertData(
                table: "Kuriri",
                columns: new[] { "Id", "GodinaRodjenja", "Ime" },
                values: new object[] { 2, 2000, "Marko" });

            migrationBuilder.InsertData(
                table: "Kuriri",
                columns: new[] { "Id", "GodinaRodjenja", "Ime" },
                values: new object[] { 3, 1995, "Mitar" });

            migrationBuilder.InsertData(
                table: "Paketi",
                columns: new[] { "Id", "Dostavljen", "KurirId", "Posiljalac", "Postarina", "Primalac", "Tezina" },
                values: new object[] { 1, true, 1, "Galens", 0, "Vega", 5m });

            migrationBuilder.InsertData(
                table: "Paketi",
                columns: new[] { "Id", "Dostavljen", "KurirId", "Posiljalac", "Postarina", "Primalac", "Tezina" },
                values: new object[] { 2, false, 2, "Maxi", 0, "Idea", 7m });

            migrationBuilder.InsertData(
                table: "Paketi",
                columns: new[] { "Id", "Dostavljen", "KurirId", "Posiljalac", "Postarina", "Primalac", "Tezina" },
                values: new object[] { 3, true, 3, "Giros Master", 0, "GreenNet", 4m });
